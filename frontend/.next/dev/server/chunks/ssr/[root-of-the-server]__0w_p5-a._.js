...
const metadata = {
    ...
    description: 'AI-powered travel planning system that helps you generate optimized itineraries, discover places, and navigate efficiently based on your preferences.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
